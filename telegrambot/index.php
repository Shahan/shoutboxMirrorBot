...
define('WEBHOOK_URL', 'https://mywebsite.com/bot/');
define('WEBCHAT_URL', 'http://mywebsite.com/webchat/');
...
function sendToWebChat($parameters) {
	//set POST variables
	$url = WEBCHAT_URL;
	$fields = $parameters;
...
function processMessage($message) {
  ...
  if (isset($message['text'])) {
    ...
    /*if (strpos($text, "/start") === 0) {
	  ...
	  else if (strpos($text, "/me") === 0)
	  {
		  $answer = 'Your id: '.$from;
	  }
	  else if (strpos($text, "/send") === 0)
	  {
